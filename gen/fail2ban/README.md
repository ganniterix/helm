# Helm chart (V3) - fail2ban

## fail2ban

[Fail2ban](http://www.fail2ban.org/) is a daemon to ban hosts that cause multiple authentication errors.

The the docker image is part of the the [`linuxserver.io`](https://www.linuxserver.io/) collection, it has a great [documentation](https://github.com/linuxserver/docker-fail2ban) that cover all the image features.
...
```bash
helm install fail2ban fail2ban
```
