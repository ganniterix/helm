# Helm chart (V3) - nextcloud

## nextcloud

[Nextcloud](https://nextcloud.com/) gives you access to all your files wherever you are.

The the docker image is part of the the [`linuxserver.io`](https://www.linuxserver.io/) collection, it has a great [documentation](https://github.com/linuxserver/docker-nextcloud) that cover all the image features.
