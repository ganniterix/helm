# Helm chart (V3) - thelounge

## thelounge

[Thelounge](https://thelounge.github.io/) (a fork of shoutIRC) is a web IRC client that you host on your own server.

The the docker image is part of the the [`linuxserver.io`](https://www.linuxserver.io/) collection, it has a great [documentation](https://github.com/linuxserver/docker-thelounge) that cover all the image features.
...
```bash
helm install thelounge thelounge
```
