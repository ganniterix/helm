# Helm chart (V3) - unifi-network-application
...
The the docker image is part of the the [`linuxserver.io`](https://www.linuxserver.io/) collection, it has a great [documentation](https://github.com/linuxserver/docker-unifi-network-application) that cover all the image features.
...
```bash
helm install unifi-network-application unifi-network-application
```
