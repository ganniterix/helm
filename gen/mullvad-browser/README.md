# Helm chart (V3) - mullvad-browser

## mullvad-browser

[![mullvad-browser](https://raw.githubusercontent.com/linuxserver/docker-templates/master/linuxserver.io/img/mullvad-browser-logo.png)](https://mullvad.net/en/browser)

The the docker image is part of the the [`linuxserver.io`](https://www.linuxserver.io/) collection, it has a great [documentation](https://github.com/linuxserver/docker-mullvad-browser) that cover all the image features.
...
```bash
helm install mullvad-browser mullvad-browser
```
