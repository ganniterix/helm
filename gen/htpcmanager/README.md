# Helm chart (V3) - htpcmanager

## htpcmanager

[Htpcmanager](https://github.com/HTPC-Manager/HTPC-Manager) is a front end for many htpc related applications.

The the docker image is part of the the [`linuxserver.io`](https://www.linuxserver.io/) collection, it has a great [documentation](https://github.com/linuxserver/docker-htpcmanager) that cover all the image features.
...
```bash
helm install htpcmanager htpcmanager
```
