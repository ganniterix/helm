# Helm chart (V3) - hedgedoc

## hedgedoc

[HedgeDoc](https://hedgedoc.org/) gives you access to all your files wherever you are.

The the docker image is part of the the [`linuxserver.io`](https://www.linuxserver.io/) collection, it has a great [documentation](https://github.com/linuxserver/docker-hedgedoc) that cover all the image features.
...
```bash
helm install hedgedoc hedgedoc
```
