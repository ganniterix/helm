# Helm chart (V3) - plex-meta-manager
...
The the docker image is part of the the [`linuxserver.io`](https://www.linuxserver.io/) collection, it has a great [documentation](https://github.com/linuxserver/docker-plex-meta-manager) that cover all the image features.
...
```bash
helm install plex-meta-manager plex-meta-manager
```
