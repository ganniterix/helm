# Helm chart (V3) - flexget

## flexget

[Flexget](http://flexget.com/) is a multipurpose automation tool for all of your media.

The the docker image is part of the the [`linuxserver.io`](https://www.linuxserver.io/) collection, it has a great [documentation](https://github.com/linuxserver/docker-flexget) that cover all the image features.
